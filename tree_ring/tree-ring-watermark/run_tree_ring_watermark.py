...
def main(args):
    ...
    for i in tqdm(range(args.start, args.end)):
        ...
        # rev_latents_w_fft = torch.fft.fftshift(torch.fft.fft2(reversed_latents_w), dim=(-1, -2)).real
        # visualize_tensor(rev_latents_w_fft, name='./real_rev.png')
        # rev_latents_w_fft = torch.fft.fftshift(torch.fft.fft2(reversed_latents_w), dim=(-1, -2)).imag
        # visualize_tensor(rev_latents_w_fft, name='./imag_rev.png')
